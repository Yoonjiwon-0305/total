...
## Clock signal
#set_property -dict { PACKAGE_PIN W5   IOSTANDARD LVCMOS33 } [get_ports cak]
#create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_parts clk]a
## Switchea
...
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports {c}]
